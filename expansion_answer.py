...
file_name = "microsoft-annual-report.pdf"
...
# Import chromadb and the SentenceTransformerEmbeddingFunction
import chromadb
...
# Instantiate the Chroma client and create a collection called "microsoft-collection"
chroma_client = chromadb.Client()
chroma_collection = chroma_client.create_collection("microsoft-collection", embedding_function=embedding_function)
...
query = "what was the total revunue for the year?"
